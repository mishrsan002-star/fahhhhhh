...
self.JobSchedulerDOM = class {
  ...
  async Init() {
    ...
    var a = this._runtimeInterface._GetWorkerURL(
      this._GetWorkerScriptFolder() +
        "https://cdn.jsdelivr.net/gh/bubbls/UGS-Assets@main/throw-a-patata-space/scripts/dispatchworker.js",
    );
...
window.C3_IsSupported &&
  (window.c3_runtimeInterface = new self.RuntimeInterface({
    useWorker: !0,
    workerMainUrl:
      "https://cdn.jsdelivr.net/gh/bubbls/UGS-Assets@main/throw-a-patata-space/workermain.js",
    engineScripts: [
      "https://cdn.jsdelivr.net/gh/bubbls/UGS-Assets@main/throw-a-patata-space/scripts/c3runtime.js",
    ],
    projectScripts: [],
    mainProjectScript: "",
    scriptFolder:
      "https://cdn.jsdelivr.net/gh/bubbls/UGS-Assets@main/throw-a-patata-space/scripts/",
    workerDependencyScripts: [
      "https://cdn.jsdelivr.net/gh/bubbls/UGS-Assets@main/throw-a-patata-space/box2d.wasm.js",
    ],
    exportType: "html5",
  }));
("use strict");
